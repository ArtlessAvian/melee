...
{
    Item* temp_r5 = item_gobj->user_data;
    temp_r5->owner = NULL;
    temp_r5->xDC8_word.flags.x13 = true;
...
void it_802B2AE0(Item_GObj* arg0)
{
    Item_80268E5C((HSD_GObj*) arg0, 0, ITEM_ANIM_UPDATE);
}

void it_802B2B08(Item_GObj* arg0)
{
    Item* temp_r31 = arg0->user_data;
    f32* unkc4_unk4 = temp_r31->xC4_article_data->x4_specialAttributes;
    Item_80268E5C(arg0, 1, ITEM_ANIM_UPDATE);
    it_80275158(arg0, *unkc4_unk4);
}
...
void it_802B2BA8(Item_GObj* arg0)
{
...
bool it_802B2C04(Item_GObj* arg0)
{
    if ((s32) ((Item*) arg0->user_data)->msid != 2) {
        it_802B2C38(arg0);
    }
    return 0;
}
...
void it_802B2C38(Item_GObj* arg0)
{
    ...
    // temp_r29, &sp1C);
    Item_8026AE84((Item*) temp_r31, 0x44618, 0x7F, 0x40);
}

void it_802B2D30(Item_GObj* arg0)
{
    it_802751D8(arg0);
}

bool it_802B2D50(Item_GObj* arg0)
{
    f32 sp20;
    HSD_JObj* temp_r30;
    Item* temp_r29;
    ...
    if ((s32) temp_r29->msid != 2) {
        temp_r30 = arg0->hsd_obj;
        temp_r31 = temp_r29->xC4_article_data->x4_specialAttributes;
        Item_80268E5C((HSD_GObj*) arg0, 2, 0x12);
        it_8026BB44(arg0);
        it_80273598(arg0, 0xC, 0xA);
        it_8026BD24(arg0);
        ...
        Item_8026AE84(temp_r29, 0x44618, 0x7F, 0x40);
    }
    return 0;
}

bool it_802B2E5C(Item_GObj* arg0)
{
    return it_80273030(arg0);
}

bool it_802B2E7C(Item_GObj* arg0)
{
    // HACK: Commented out compile erroring code.
    f32 sp20;
    HSD_JObj* temp_r30;
...
bool it_802B2F88(Item_GObj* arg0)
{
    return itColl_BounceOffShield(arg0);
}

bool it_802B2BD8(Item_GObj* arg0)
{
    it_8026E5A0(arg0, it_802B2C38);
    return 0;
}
